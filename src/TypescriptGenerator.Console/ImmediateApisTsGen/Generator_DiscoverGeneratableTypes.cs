...
internal partial class Generator
{
	internal List<TypeDescriptor> DiscoverGeneratableTypes()
	{
		...
		{
			var requestTypeCollector = new GeneratableTypeCollector(
				config.GenerateTypesInNamespacesIncludes,
				config.GenerateTypesInNamespacesExcludes,
				TypeUsage.Request);
			var returnTypeCollector = new GeneratableTypeCollector(
				config.GenerateTypesInNamespacesIncludes,
				config.GenerateTypesInNamespacesExcludes,
				TypeUsage.Response);
